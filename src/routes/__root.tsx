  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="font-head text-7xl font-semibold text-foreground">404</h1>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Smart Business Assistant" },
      {
        name: "description",
        content:
          "One desk for client email drafts, meeting summaries and an AI task plan for busy teams.",
      },
      { property: "og:title", content: "Smart Business Assistant" },
      {
